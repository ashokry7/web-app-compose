...
The docker compose file also defines two bridge networks, front-end network for communication between the load balancer and the backend python app, and another 
